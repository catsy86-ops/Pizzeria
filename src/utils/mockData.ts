...
export const MENU_PIZZAS: Pizza[] = [
  ...
  },
  {
    id: 'm6',
    name: 'Diavola',
    description: 'Pikantne salami, papryczki jalapeño, czerwona cebula i ostry sos pomidorowy.',
    price: 44.00,
    image: 'https://images.unsplash.com/photo-1593560708920-61dd98c46a4e?auto=format&fit=crop&w=800&q=80',
    toppings: [TOPPINGS[3], TOPPINGS[2]],
  },
  {
    id: 'm7',
    name: 'Quattro Formaggi',
    description: 'Aromatyczna kompozycja czterech serów: mozzarella, gorgonzola, parmezan i ser kozi.',
    price: 45.00,
  ...
  },
  {
    id: 'm8',
    name: 'Capricciosa',
    description: 'Klasyczna włoska szynka, pieczarki, karczochy i czarne oliwki.',
    price: 42.00,
  ...
  },
  {
    id: 'm9',
    name: 'Trufle & Rucola',
    description: 'Kremowa pasta truflowa, dzikie pieczarki, świeża rukola i płatki parmezanu.',
    price: 49.00,
